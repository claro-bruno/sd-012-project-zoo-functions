...
function getSpeciesByIds(...ids) { // OK
  // seu código aqui
...
function getAnimalsOlderThan(animal, age) { // OK
  // seu código aqui
  return data.species
...
function getEmployeeByName(employeeName) { // OK
  // seu código aqui
...
function createEmployee(personalInfo, associatedWith) { // OK
  // seu código aqui
...
function countAnimals(species) { // OK
  // seu código aqui
  if (!species) {
